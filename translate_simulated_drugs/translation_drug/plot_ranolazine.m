%Rano CIPA 1x   %ECGNo.75 (after deletion of failed no.71) 
...
male_rano =  cell2mat(struct2cell(load('ecg_gen1_1x_75.mat')));
female_rano =  cell2mat(struct2cell(load('ecg_gen2_1x_75.mat')));

figure(1); hold on; set(gcf, 'color', 'w'); 
plot(ts_sample - 49000, male_control , 'linewidth', 2, 'Color', [1, 0, 1]); 
plot(ts_sample - 49000, male_rano , 'linewidth', 2, 'Color', [0.6431, 0.2549, 0.7020]); 
plot(ts_sample - 49000, female_rano , 'linewidth', 2, 'Color', [0, 0, 0.8]); xlim([-10 650])
