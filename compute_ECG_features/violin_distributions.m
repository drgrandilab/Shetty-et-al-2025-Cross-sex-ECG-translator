...
output_names = {'QRSdur', 'QTint','T-peakend dur', 'T-wave amp'};
...
color_cell = {[0 0 0.8; 0.968627451 0.305882353 0.839215686]};
...
figure(8); hold on; set(gcf, 'color', 'w'); 
plot(nan, nan, '.','color', [1 1 1]); vs1 = violinplot(QRS_dur , label_violin, 'ViolinColor', color_cell, 'Width', 0.3); legend('QRS dur. (ms)'); legend boxoff 
set(findobj(gcf,'type','axes'), 'FontName','Arial','FontSize',18, 'LineWidth', 1, 'box', 'off', 'tickdir', 'out');
figure(8); set(gcf, 'Units', 'Inches', 'Position', [0 0 6 5], 'PaperUnits', 'Inches', 'PaperSize', [6, 5])
% saveas(gcf,'QRS_violin.svg')

figure(9); hold on; set(gcf, 'color', 'w'); 
plot(nan, nan,'.', 'color', [1 1 1]); vs2 = violinplot(QT_interval , label_violin, 'ViolinColor', color_cell, 'Width', 0.3); legend('QT interval (ms)'); legend boxoff 
set(findobj(gcf,'type','axes'), 'FontName','Arial','FontSize',18, 'LineWidth', 1, 'box', 'off', 'tickdir', 'out');
figure(9); set(gcf, 'Units', 'Inches', 'Position', [0 0 6 5], 'PaperUnits', 'Inches', 'PaperSize', [6, 5])
% saveas(gcf,'QT_violin.svg')

figure(10); hold on; set(gcf, 'color', 'w'); 
plot(nan, nan, '.','color', [1 1 1]); vs3 = violinplot(Tpeak_end , label_violin, 'ViolinColor', color_cell, 'Width', 0.3); legend('T-peak-end dur. (ms)'); legend boxoff 
set(findobj(gcf,'type','axes'), 'FontName','Arial','FontSize',18, 'LineWidth', 1, 'box', 'off', 'tickdir', 'out');
figure(10); set(gcf, 'Units', 'Inches', 'Position', [0 0 6 5], 'PaperUnits', 'Inches', 'PaperSize', [6, 5])
% saveas(gcf,'Tpeakend_violin.svg')

figure(11); hold on; set(gcf, 'color', 'w'); 
plot(nan, nan, '.','color', [1 1 1]); vs4 = violinplot(Twave_amp , label_violin, 'ViolinColor', color_cell, 'Width', 0.3); legend('T-wave amp. (a.u)'); legend boxoff 
set(findobj(gcf,'type','axes'), 'FontName','Arial','FontSize',18, 'LineWidth', 1, 'box', 'off', 'tickdir', 'out');
figure(11); set(gcf, 'Units', 'Inches', 'Position', [0 0 6 5], 'PaperUnits', 'Inches', 'PaperSize', [6, 5])
% saveas(gcf,'Twaveamp_violin.svg')
% figure(8); set(gcf, 'Units', 'Inches', 'Position', [0 0 12 10], 'PaperUnits', 'Inches', 'PaperSize', [12, 10])
%f = gcf; exportgraphics(f, 'feature_distribution.png', 'Resolution', 300)

figure(12); hold on; set(gcf, 'color', 'w'); 
subplot(2,2,1);hold on; plot(nan, nan, '.','color', [1 1 1]); vs1 = violinplot(QRS_dur , label_violin, 'ViolinColor', color_cell, 'Width', 0.3);  legend boxoff ; % legend('QRS dur. (ms)');
subplot(2,2,2);hold on; plot(nan, nan,'.', 'color', [1 1 1]); vs2 = violinplot(QT_interval , label_violin, 'ViolinColor', color_cell, 'Width', 0.3); legend('QT interval (ms)'); legend boxoff ; %legend('QT interval (ms)'); 
subplot(2,2,3);hold on; plot(nan, nan, '.','color', [1 1 1]); vs3 = violinplot(Tpeak_end , label_violin, 'ViolinColor', color_cell, 'Width', 0.3); legend boxoff ; %legend('T-peak-end dur. (ms)'); 
subplot(2,2,4);hold on; plot(nan, nan, '.','color', [1 1 1]); vs4 = violinplot(Twave_amp , label_violin, 'ViolinColor', color_cell, 'Width', 0.3); legend boxoff ; %legend('T-wave amp. (a.u)'); 
set(findobj(gcf,'type','axes'), 'FontName','Arial','FontSize',20, 'LineWidth', 1, 'box', 'off', 'tickdir', 'out');
figure(12); set(gcf, 'Units', 'Inches', 'Position', [0 0 12 8], 'PaperUnits', 'Inches', 'PaperSize', [12, 8])
saveas(gcf,'violin all.svg')
